    ...
    <footer id="contact" className="py-10  px-6 border-t border-white/10">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex justify-center gap-6 mt-12">
          <Link
            href="https://www.instagram.com/aungkyawoo.mercury/"
            target="_blank"
          ...
          <Link
            href="https://github.com/AungKyawOo-dev"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
            aria-label="GitHub"
          ...
          <Link
            href="https://www.fiverr.com/users/aungkyawoo2821"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
            aria-label="Fiverr"
          >
            <Image
              src="https://d3tnn7lar6ozas.cloudfront.net/20f7a02e-3167-4da8-9623-80905011fa25.svg"
              alt="Fiverr"
              width={20}
              height={20}
              className="w-5 h-5"
        ...
        <div className="text-center mt-12 pt-8 border-t border-white/10">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} Aung Kyaw Oo. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
