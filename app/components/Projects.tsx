...
const featuredProjects: Project[] = [
  {
    id: 1,
    title: "Point System Web Admin (Dashboard)",
    description: "A comprehensive admin dashboard for managing cash-in/cash-out workflows, reward redemptions, and point tracking. Features include real-time notifications, detailed activity logs, and a responsive UI built with Vue.js and Vuetify. Optimized for performance with sorting, filtering, and pagination capabilities.",
    link: "",
