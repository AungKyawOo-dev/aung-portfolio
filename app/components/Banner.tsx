...
export default function Banner(): React.JSX.Element {
  const texts = ["Backend Developer", "Web Developer", "Java Developer"];
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
              ...
              <div className="lg:hidden  -top-150 z-10">
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Aung Kyaw Oo</span>
                    </p>
                ...
                <Image
                  src="/assets/me.png"
                  alt="Aung Kyaw Oo - Backend/Web Developer"
                  width={300}
                  height={300}
            ...
            <div className="flex-1 space-y-6 text-center lg:text-left">
              ...
              <div className="">
                ...
                <p className="text-md text-white/80">
                  Because robust backend infrastructure is the backbone of every great application.
                </p>
              </div>
            </div>
          </div>
          <div className="space-y-3 pt-15 text-center lg:text-left">
            ...
            <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
              ...
              <span className="flex items-center gap-2">
                <span className="text-blue-400 font-semibold">Freelance Developer</span>
              </span>
            </p>
            <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
              Backend/Web-focused developer with over 5 years of experience building secure financial systems, banking platforms, and administrative dashboards.
            </p>
          </div>
        </div>
      </div>
